            ...
            <div className="relative w-full max-w-4xl h-[400px] md:h-[500px] rounded-2xl overflow-hidden shadow-2xl group">
                ...
                >
                    ...
                    <img 
                        ...
                        alt="" 
                        className="absolute inset-0 w-full h-full object-cover blur-2xl opacity-40 scale-105 pointer-events-none transition-opacity duration-700"
                    />

                    {/* Main Image with object-contain to preserve full view */}
                    <img 
                        key={currentSlide}
                        src={teamImages[currentSlide]} 
                        alt={`Team member ${currentSlide + 1}`} 
                        className="relative w-full h-full object-contain transition-all duration-500 ease-in-out z-0"
                    />
